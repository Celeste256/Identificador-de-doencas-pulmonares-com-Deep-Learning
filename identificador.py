...
# Load the labels
class_names = ['pneumonia','tuberculose','normal']

# CAMERA can be 0 or 1 based on default camera of your computer
img = cv2.imread("imagens/testPneumonia/PNEUMONIA/person3_virus_16.jpeg")  
...
texto2 = f"Acuracia: {str(np.round(confidence_score * 100))[:-2]} %"
